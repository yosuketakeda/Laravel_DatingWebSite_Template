...
<div class="login_img">
    <div class="container">
        <div class="col-sm-6 col-md-6 col-lg-6 login_field">
            ...
            <a class="adding">Passwort vergessen?</a>
        </div>
        <div class="col-sm-6 col-md-6 col-lg-6 register_field">
            ...
            <input type="checkbox" name="check_policy" id="check_policy" class="css-checkbox" required>
            ...
            <button class="register_btn">JETZT REGESTRIEREN</button><br>
        </div>
    </div>
</div>
